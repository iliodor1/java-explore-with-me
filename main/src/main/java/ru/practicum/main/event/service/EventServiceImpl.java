...
import ru.practicum.main.exeption.ConflictRequestException;
...
public class EventServiceImpl implements EventService {
    ...
    public List<Event> getEvents(
            ...
            ru.practicum.main.event.model.Sort sortEnum,
            Integer from,
            Integer size
    ) {
        Pageable pageable;

        if (sortEnum == ru.practicum.main.event.model.Sort.EVENT_DATE) {
